    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bind = [
          ...
          " $mainMod SHIFT, F7, exec, ${pkgs.firefox}/bin/firefox -taskbar-tab 0d3d0b31-a5ea-4e57-9d56-a41dc1dcae87 -new-window https://outlook.cloud.microsoft/mail/ -profile ${config.home.homeDirectory}/.mozilla/firefox/kyle -container 0"
          " $mainMod, F8, workspace, 8"
          " $mainMod, F8, exec, ${pkgs.firefox}/bin/firefox -taskbar-tab 0b58dce7-64bb-42fb-90b8-97001b79f643 -new-window https://teams.cloud.microsoft -profile ${config.home.homeDirectory}/.mozilla/firefox/kyle -container 0"
